# Databázové systémy (ERA → SQL → PostGIS)

Vítej v materiálech ke cvičením.

## Rychlá navigace
- [Sylabus](syllabus.md)
- [Hodnocení](grading.md)
- Nastavení:
  - [PostgreSQL](setup/postgres.md)
  - [PostGIS](setup/postgis.md)
  - [QGIS připojení](setup/qgis.md)
- Cvičení:
  - [01 – ERA základy](exercises/01-era-basics.md)
  - [02 – ERA pokročilé](exercises/02-era-advanced.md)
  ...
  - [09 – Postgis](exercises/09-postgis-zaklady.md)
